...
-- Thông báo chào mừng
Notification.new("<Color=Yellow>DIO Hub <Color=/>"):Display()
task.wait(1)
...
_G.imageLogo = "rbxassetid://89004559707540"
_G.Logo = "rbxassetid://89004559707540"
_G.NameHub = "Blox Fruits" -- ชื่อ Hub
_G.Title = "DIO Hub " -- คำอธิบาย
-----------------------------------------------------------------
...
Discord.MouseButton1Click:Connect(function()
    (setclipboard or toclipboard)("https://discord.gg/MjGt2bTWBS")
    wait(.1)
...
game:GetService("StarterGui"):SetCore(
    "SendNotification",
    {
        Title = "DIO Hub ",
        Text = "Đã Tải Xong",
        Icon = "rbxassetid://89004559707540",
        Duration = 5
    }
)
